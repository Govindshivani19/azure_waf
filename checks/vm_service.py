            ...
            for subscription in subscription_list:
                ...
                for instance in instance_list:
                    ...
                    if x:
                        ...
                        guest_config_url = base_url + instance[
                            "id"] + "/providers/Microsoft.GuestConfiguration/guestConfigurationAssignments"
                        guest_config_response = rest_api_call(self.credentials, guest_config_url,
                        ...
                        if "Message" in guest_config_response.keys():
                            ...
                            for x in guest_config_response['value']:
                                if x["name"] == "WindowsPendingReboot" and x["properties"][
                ...
                for instance in instance_list:
                    ...
                    if x:
                        ...
                        if "Message" in guest_config_response.keys():
                            ...
                            for x in guest_config_response['value']:
                                if x["name"] == "MachineLastBootUpTime" and x["properties"][
                                    "complianceStatus"] == "Compliant":
                                    temp["status"] = "Pass"
