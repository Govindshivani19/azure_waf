...
def execute_storage_checks(task_id, storage_service):
    CEN_AZ_4(task_id, storage_service)
    CEN_AZ_5(task_id, storage_service)
    CEN_AZ_7(task_id, storage_service)
    CEN_AZ_8(task_id, storage_service)
    CEN_AZ_2(task_id, storage_service)
